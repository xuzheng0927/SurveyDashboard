var resize = function() {
    ...
    function resizeQueryElements(qcID){
        ...
        for (var i=0; i<allQueryCharts.length; i++) {
            ...
            if ($(allQueryCharts[i]).find(".chart-container").hasClass("heatmap")) {
                ...
                .text(function(d){return heatmap.fitWordingLength($(this),$(this).parent(),3,$(this).attr("direction"));})
            ...
            if ($(allQueryCharts[i]).find(".chart-container").hasClass("scatter") | $(allQueryCharts[i]).find(".chart-container").hasClass("correlation")) {
                ...
                .text(function(d){return d;})
                .text(function(d){return heatmap.fitWordingLength($(this),$(this).parent(),3);})
                .append("title").text(function(d){return d;});
    ...
    return {
        resizeQueryElements:        resizeQueryElements,
        resizeOverviewHistogram:    resizeOverviewHistogram
    }
}();